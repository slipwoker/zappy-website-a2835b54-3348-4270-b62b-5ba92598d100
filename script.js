document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const getErrorMessage = function (field, ruleName) {
      const messages = {
      ...
      return (
        field.dataset['error' + ruleName.charAt(0).toUpperCase() + ruleName.slice(1)] ||
        messages[ruleName] ||
        'Invalid value.'
      );
    };
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Brawl GG משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a2835b54-3348-4270-b62b-5ba92598d100',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a2835b54-3348-4270-b62b-5ba92598d100';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a2835b54-3348-4270-b62b-5ba92598d100';
